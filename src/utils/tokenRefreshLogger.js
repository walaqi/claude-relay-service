...
if (isWorkerMode()) {
  ...
  const consoleLog =
    (event) =>
    (...args) =>
      console.log(`[TOKEN_REFRESH:${event}]`, ...args)
  ...
  module.exports = {
    ...
    logRefreshStart: consoleLog('START'),
    logRefreshSuccess: consoleLog('SUCCESS'),
    logRefreshError: consoleLog('ERROR'),
    logRefreshSkipped: consoleLog('SKIPPED'),
    logTokenUsage: noop,
    logBatchRefreshStart: consoleLog('BATCH_START'),
    logBatchRefreshComplete: consoleLog('BATCH_COMPLETE')
  }
} else {
